...
const FooterInfo = () => {
  return (
    <footer className="1lg:block py-8 bg-[#e5e5e5] border-t-[12px] border-t-[#187733]">
      <div className="w-[80vw] mx-auto flex flex-col bg-white p-5 rounded-lg">
        <div className="flex gap-5 border-b border-b-[#b2bac6]">
          <div className="flex-[25%_1]">
            <p className="font-bold text-[#5e6f88] mb-5">Về NB Pharmacy</p>
          ...
          <div className="flex-[25%_1]">
            ...
            <a href="/#">
              <p className="flex items-center text-black mb-5">
                <FaYoutube className="text-red-700 text-xl mr-2" />
                Youtube
              </p>
            </a>
            ...
            <a href="/#">
              <p className="flex items-center text-black mb-5">
                <FaTiktok className="text-black text-xl mr-2" />
                Tiktok
              </p>
            </a>
